        ...
        <div>
            <div className='lg:flex justify-evenly items-center'>
                <div className='p-4 text-center'>
                    ...
                    <button className='border-4 rounded-lg bg-yellow-400 py-2 px-4'>Go Shop</button>
                </div>
            ...
            <div className='my-10'>
                ...
                <div >
                    {homeReviews.length === 3 && <button className='border-4 rounded-lg bg-yellow-400 py-2 px-4' onClick={() => getMoreShop(reviewId)}>See All</button>}
                </div>
            </div>
        </div>
    );
